...
class Admin::ProductsTest < ApplicationSystemTestCase
  ...
  test "should create product" do
    ...
    fill_in "Color", with: @admin_product.color_id
    fill_in "Description", with: @admin_product.description
    fill_in "Colors", with: @admin_colors.colors
    fill_in "Name", with: @admin_product.name
    fill_in "Color Name", with: @admin_color_name.color_name
    fill_in "Color Code", with: @admin_color_code.color_code
