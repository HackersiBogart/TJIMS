...
class Admin::ProductStocksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_product_stock" do
    assert_difference("Admin::ProductStock.count") do
      post admin_product_stocks_url, params: { admin_product_stock: { amount: @admin_product_stock.amount, price: @admin_product_stock.price, product_id: @admin_product_stock.product_id, size: @admin_product_stock.size, unit: @admin_product_stock.unit } }
    end
  ...
  test "should update admin_product_stock" do
    patch admin_product_stock_url(@admin_product_stock), params: { admin_product_stock: { amount: @admin_product_stock.amount, price: @admin_product_stock.price, product_id: @admin_product_stock.product_id, size: @admin_product_stock.size, unit: @admin_product_stock.unit } }
